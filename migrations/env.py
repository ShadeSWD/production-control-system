...
from production_tasks.datatbase import Base
from production_tasks.models import Product, WorkShift
...
config.set_section_option(section, "DB_PASS", environ.get("DB_PASSWORD"))
